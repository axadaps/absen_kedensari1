<div class="card-body">
    <div class="row">
        ...
        <div class="col">
            <a class="btn btn-success ml-3 pl-3 py-3" href="<?= base_url('admin/absen-siswa/send'); ?>">
                 <i class="material-icons mr-2">send</i> Kirim Notifikasi
            </a>
            <a href="#" class="btn btn-primary ml-3 pl-3 py-3" onclick="kelas = onDateChange()" data-toggle="tab">
