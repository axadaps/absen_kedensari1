...
class SiswaModel extends Model
{
   ...
   public function getAllSiswaWithKelas($kelas = null)
   {
      $query = $this->join(
         'tb_kelas',
         'tb_kelas.id_kelas = tb_siswa.id_kelas',
   ...
   public function getPresensiSiswa(){
      // return $this->join('tb_presensi_siswa', 'tb_presensi_siswa.id_siswa = tb_siswa.id_siswa', "INNER JOIN")->where
   }
}
